...
export class VendedorUsuarioVendedorController {
  ...
  async get(
    ...
    return this.vendedorRepository.tiene_un(id).get(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.tiene_un(id).create(usuarioVendedor);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.tiene_un(id).patch(usuarioVendedor, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.tiene_un(id).delete(where);
  }
}
